          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 8,),
                  Text("Informasi Pembayaran", style: primaryTextStyle.copyWith(
                    fontSize: 18,
                    fontWeight: FontWeight.w800,
                  ),),
                  Padding(
                    padding: const EdgeInsets.only(left: 33, right: 33, top: 18, bottom: 24),
                    child: Column(
                      children: [
                        Text("Total pembayaran akan di rekap oleh tim saat penjemputan dan penimbangan", style: primaryTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.w400,
                        ),),
                        SizedBox(height: 15,),
